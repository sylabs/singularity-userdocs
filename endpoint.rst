...
`push
<https://www.sylabs.io/guides/{version}/user-guide/cli/singularity_push.html>`_,
`build --remote
<https://www.sylabs.io/guides/{version}/user-guide/cli/singularity_build.html#options>`_,
`key
<https://www.sylabs.io/guides/{version}/user-guide/cli/singularity_key.html>`_,
`search
<https://www.sylabs.io/guides/{version}/user-guide/cli/singularity_search.html>`_,
`verify
<https://www.sylabs.io/guides/{version}/user-guide/cli/singularity_verify.html>`_,
`exec
...
`instance
<https://www.sylabs.io/guides/{version}/user-guide/cli/singularity_instance.html>`_
